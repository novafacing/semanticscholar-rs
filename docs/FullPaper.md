...
**authors** | Option<[**Vec<crate::models::AuthorInfo>**](Author_Info.md)> |  | [optional]
**citations** | Option<[**Vec<crate::models::PaperInfo2>**](PaperInfo2.md)> |  | [optional]
**references** | Option<[**Vec<crate::models::PaperInfo2>**](Paper_Info_2.md)> |  | [optional]
**embedding** | Option<[**crate::models::Embedding**](Embedding.md)> |  | [optional]
**tldr** | Option<[**crate::models::Tldr**](Tldr.md)> |  | [optional]
