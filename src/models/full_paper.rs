...
pub struct FullPaper {
    ...
    pub citations: Option<Vec<crate::models::PaperInfo2>>,
    #[serde(rename = "references", skip_serializing_if = "Option::is_none")]
    pub references: Option<Vec<crate::models::PaperInfo2>>,
    #[serde(rename = "embedding", skip_serializing_if = "Option::is_none")]
    pub embedding: Option<Box<crate::models::Embedding>>,
    #[serde(rename = "tldr", skip_serializing_if = "Option::is_none")]
    pub tldr: Option<Box<crate::models::Tldr>>,
}

impl FullPaper {
    pub fn new(paper_id: String) -> FullPaper {
        FullPaper {
            paper_id,
            external_ids: None,
            url: None,
