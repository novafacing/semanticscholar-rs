...
/// CitationCitingPaper : Details about the citing paper



#[derive(Clone, Debug, PartialEq, Default, Serialize, Deserialize)]
pub struct CitationCitingPaper {
...
impl CitationCitingPaper {
    /// Details about the citing paper
    pub fn new(paper_id: String) -> CitationCitingPaper {
        CitationCitingPaper {
            paper_id,
            external_ids: None,
            url: None,
