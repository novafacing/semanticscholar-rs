...
pub struct ContentsOfThisBatch2 {
    ...
    #[serde(rename = "papers", skip_serializing_if = "Option::is_none")]
    pub papers: Option<Vec<crate::models::PaperInfo>>,
}

impl ContentsOfThisBatch2 {
    pub fn new(author_id: String) -> ContentsOfThisBatch2 {
